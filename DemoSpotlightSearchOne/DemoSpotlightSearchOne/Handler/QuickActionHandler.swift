...
class QuickActionHandler {
    ...
    func handleQuickAction(_ shortcutItem:UIApplicationShortcutItem) {
        ...
        case .search:
            ...
            NotificationCenter.default.post(name: .buyCoffee, object: nil)
        case .savedItems:
            NotificationCenter.default.post(name: .buyCoffee, object: nil)
...
extension NSNotification.Name {
    static let buyCoffee = NSNotification.Name("BuyCoffee")
    static let search = NSNotification.Name("search")
    static let savedItems = NSNotification.Name("SavedItems")
}
