...
////  SoundAnalyserDemo
////
////  Created by MacBook_Air_41 on 08/09/24.
////
//
//import UIKit
//import CoreML
...
//
//@available(iOS 15.0, *)
//class CoreMLVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
//    
...
//    let model:MySoundClassifier = MySoundClassifier()
//    
...
//        self.pickerData = ["clock_tick", "chainsaw", "sneezing", "sea_waves", "rooster", "rain", "baby_crying", "cry", "dog_barking"]
//    }
//    
