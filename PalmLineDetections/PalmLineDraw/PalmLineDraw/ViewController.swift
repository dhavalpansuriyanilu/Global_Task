...
//            self.scrollViewToZoom.contentSize = self.scrollViewToZoom.frame.size
    ...
    //                        self.imageView.image = processedImage  // Show processed image
    //                    }
    ...
    func uploadImageToAPI(image: UIImage, completion: @escaping ([String: Any]?, UIImage?) -> Void) {
        let url = URL(string: "http://192.168.29.148:8000/predict/")!//"http://127.0.0.1:8000/predict/"
...
//        let baseScale: CGFloat = 3.0  // Default zoom scale
//        let maxDimension = max(imageSize.width, imageSize.height)  // Get the largest dimension
//
//        if maxDimension > 3000 {  // If the image is very large
//            return baseScale * 2  // Reduce zoom scale
//        } else if maxDimension > 2000 {
//            return baseScale * 0.7  // Slightly reduce zoom scale
//        } else {
//            return baseScale  // Keep normal zoom
//        }
    ...
    func resetZoom() {
        UIView.animate(withDuration: 0.8) {
            self.zoomImage()
//            self.scrollViewToZoom.setZoomScale(1.0, animated: true)
//            self.scrollViewToZoom.setContentOffset(CGPoint(x: 0, y: 0), animated: true)
        }
    }
